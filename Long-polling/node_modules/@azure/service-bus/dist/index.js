...
(function (ConnectionContext) {
    ...
    function create(config, tokenProvider, options) {
        ...
        function addConnectionListeners(connection) {
            ...
            connection.on(rheaPromise.ConnectionEvents.error, error$1);
        }
        function cleanConnectionContext(connectionContext) {
            return tslib.__awaiter(this, void 0, void 0, function* () {
                ...
                connectionContext.connection.removeListener(rheaPromise.ConnectionEvents.error, error$1);
...
class MessageSender extends LinkEntity {
    ...
    constructor(context) {
         ...
         * @readonly
         */
        this.openLock = `sender-${rheaPromise.generate_uuid()}`;
    ...
    open(options) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            return amqpCommon.defaultLock.acquire(this.openLock, () => tslib.__awaiter(this, void 0, void 0, function* () {
                try {
    ...
    onDetached(receiverError, causedByDisconnect) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const translatedError = receiverError ? amqpCommon.translate(receiverError) : receiverError;
    ...
    _receiveImpl(maxMessageCount, maxWaitTimeInSeconds) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this._connectionErrorHandler = (error) => {
                ...
                reject(amqpCommon.translate(error));
            };
